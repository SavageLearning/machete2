package com.savagelearning.machete.cli;

import com.savagelearning.machete.EmployerConfiguration;
...
public class RenderCommand extends ConfiguredCommand<EmployerConfiguration> {
    ...
    @Override
    protected void run(Bootstrap<EmployerConfiguration> bootstrap,
                       Namespace namespace,
                       EmployerConfiguration configuration) throws Exception {
