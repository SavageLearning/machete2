...
import com.savagelearning.machete.MacheteConfiguration;
...
public class RenderCommand extends ConfiguredCommand<MacheteConfiguration> {
    ...
    @Override
    protected void run(Bootstrap<MacheteConfiguration> bootstrap,
                       Namespace namespace,
                       MacheteConfiguration configuration) throws Exception {
